...
- `--filter-window {scipy-periodic,symmetric}` — Hanning window mode for breakpoint filtering (default: `scipy-periodic`, matching original ldetect's SciPy periodic Hann window)
