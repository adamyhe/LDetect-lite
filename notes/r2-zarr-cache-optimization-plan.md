...
| Chrom | `matrix_hdf5` | `direct_hdf5` | `r2_zarr` | `r2_nocache` |
| --- | ---: | ---: | ---: | ---: |
| 13 | 739.87 s | 821.36 s | 568.48 s | 6726.81 s |
| 21 | 171.32 s | 190.91 s | 134.37 s | 1219.80 s |
| 22 | 211.96 s | 224.59 s | 160.00 s | 1826.47 s |
