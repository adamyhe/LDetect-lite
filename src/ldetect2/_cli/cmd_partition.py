...
def register(subparsers: argparse._SubParsersAction) -> None:  # type: ignore[type-arg]
    ...
    p.add_argument("--n-individuals", required=True, type=int, metavar="N",
    ...
    p.add_argument("--window-size", type=int, default=5000, metavar="N",
    ...
    p.add_argument("--cutoff", type=float, default=1.5e-8, metavar="FLOAT",
                   help="Recombination fraction threshold for window extension "
                        "(default: 1.5e-8).")
